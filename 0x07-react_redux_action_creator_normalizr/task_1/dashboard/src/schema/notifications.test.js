...
describe('normalizeNotifications', () => {
  it('returns the correct result array', () => {
  ...
  it('returns the correct users entity', () => {
    const normalizedData = normalizeNotifications(notificationsData.notifications);
  ...
  it('returns the correct messages entity', () => {
    const normalizedData = normalizeNotifications(notificationsData.notifications);
  ...
  it('returns the correct notifications entity', () => {
    const normalizedData = normalizeNotifications(notificationsData.notifications);
